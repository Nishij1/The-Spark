...
const TubelightNavbarComplete = ({ className }) => {
  ...
  return (
    <nav className={cn("fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b mt-4", className)}>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center">
            <div className="flex items-center gap-3 bg-white/5 dark:bg-gray-900/5 border border-gray-200 dark:border-gray-700 backdrop-blur-lg py-1 px-1 rounded-full shadow-lg">
              {navigation.map((item) => {
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-3 ">
                <div className="hidden md:flex items-center space-x-2">
                  <div className="w-8 h-8 bg-gradient-to-r from-violet-800 to-zinc-50 rounded-full flex items-center justify-center">
